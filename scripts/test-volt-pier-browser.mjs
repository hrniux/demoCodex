...
const CONFIG = {
  envName: 'VOLT_PIER_TEST_URL',
  pathname: '/volt-pier.html',
  globalName: 'voltPierGame',
  captureEnv: 'VOLT_PIER_CAPTURE',
  screenshotDir: 'output/volt-pier-browser',
  scenarios: [
    {
      name: 'progress',
    ...
    },
    {
      ...
      internalExpect: { overlayVisible: true, overlayTitle: '港栈失守' },
