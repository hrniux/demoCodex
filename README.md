...
<p align="center">
  <img alt="Playable pages" src="https://img.shields.io/badge/playable_pages-51-0ea5e9?style=for-the-badge" />
  <img alt="Curated picks" src="https://img.shields.io/badge/curated_picks-45-22c55e?style=for-the-badge" />
...
DemoCodex 聚焦于“无需构建、打开即玩”的浏览器体验。当前仓库包含 51 个可直接运行的 HTML 页面，其中 `index.html` 聚合了 45 个主推作品；其余页面保留为实验原型、历史版本或扩展说明页，方便继续迭代和对照实现。
...
- `npm test` 运行当前内建的逻辑自检，现已覆盖 31 个主推页面逻辑，其中包括策略游戏与轻量应用。
