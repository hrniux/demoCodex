...
<p align="center">
  <img alt="Playable pages" src="https://img.shields.io/badge/playable_pages-49-0ea5e9?style=for-the-badge" />
  <img alt="Curated picks" src="https://img.shields.io/badge/curated_picks-43-22c55e?style=for-the-badge" />
...
DemoCodex 聚焦于“无需构建、打开即玩”的浏览器体验。当前仓库包含 49 个可直接运行的 HTML 页面，其中 `index.html` 聚合了 43 个主推作品；其余页面保留为实验原型、历史版本或扩展说明页，方便继续迭代和对照实现。
...
- `npm test` 运行当前内建的逻辑自检，现已覆盖 29 个主推策略 / 像素小游戏。
